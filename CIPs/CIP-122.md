...
In order to encode a 3 DID to multidid format. Simply use the `0x12` code as the identifier and the following data in the identifier as the identifier data.
