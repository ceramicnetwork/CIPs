...
concatBytes(
    ...
    event_cid_bytes, // [u8] a CID or the 0 byte to indicate a fencepost
)
```
...
* `event_cid_bytes` the CID of the event itself or the 0 byte for a fencepost as it doesn't reference an event. 
